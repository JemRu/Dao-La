...
<html>
	<head>
		...
		<style>
			...
			.illegal
			{
				margin: -140px -500px 160px 260px;
				text-align: initial;
				font-size: 20px;
			}
		</style>
	...
	<body>
		<div class="wrapper">
			...
			<div class="head-line">
			  ...
			  <form name="sign_in" action="/ququer/handle_login/" method="post">
			    <div class="box">
				  <div class="text">
				  ...
				  <div class="text">
					<div class="text-input">
						<input type="text" name="company_id" class="text-input-1" placeholder=" 用户邮箱">
						<input type="password" name="password"  class="text-input-3" placeholder=" 密码">
					</div>
				  </div>
				  <div class="text">
				  	  <input type="radio" style="float: left;margin-left: 65px;margin-top: 11px;">
				  	  <div class="text-radio-t">记住密码</div>
				  	<button type= "submit" class="btn-pic">登录</button>
				  </div>
				  <div class="text">
				  	<a href="#"><i>忘记密码？</i></a>
				  </div>
			  ...
			  <div class="box-bg" id="div1">
			  	<form name="log_in" action="/ququer/handle_register/" method="post">
			    <div class="box">
				  <div class="text">
				  ...
				  <div class="text">
					<div class="text-input">
						<input type="text" name="company_email" class="text-input-1" placeholder=" 邮箱">
						<input type="password" name="password" class="text-input-2" placeholder=" 密码">
						<input type="password" name="confirm" class="text-input-3" placeholder=" 重复密码">
						<div class = "illegal" id="email_illegal">邮箱不合法</div><div class = "legal" id="email_legal" hidden="true">邮箱可用</div ><div class = "illegal" id="email_exist" hidden="true">邮箱被注册</div ><div class = "clear"></div>
						<div class = "illegal" id="confirm_illegal">两次密码不一致</div><div class = "legal" id="confirm_legal"hidden="true">密码一致</div><div class = "illegal" id="confirm_none" hidden="true">密码不能为空</div><div class = "clear"></div>
						<div class = "illegal" id="password_illegal">密码不足六位</div><div class = "legal" id="password_legal"hidden="true">密码合法</div><div class = "clear"></div>
					</div>
				  </div>
			...
			<div class="main">
			  <div class="main-pic1">
				  ...
				  <a href="/ququer/download?type=pc"><div class="btn-pic">pc端下载</div></a>
			  	</div>
			  </div>
			  <p></p>
			  <div class="main-pic2">
     ...
     if (document.getElementById){
		...
		//光标移开判断Email是否合法
			$("#company_email").blur(function(){
				...
				$.post("<?php echo site_url();?>/ququer/email_check",{email:email},function(msg){
					if(msg==1){
						$('#email_illegal').show();
						$('#email_legal').hide();
						$('#email_exist').hide();
