...
*/
	...
	{
		$this->sql="select company_id, activation_time from company where activation = '$activation' and status = 0";
...
*/	
	function set_company_info($company_info)
	{
		...
		if($data)
		{
			...
			$this->sql = "INSERT  INTO `app_ququsignin`.`signin` (company_id, morning_in, afternoon_in, morning_out, afternoon_out) VALES($company_id,'$morning_in','$afternoon_in','$morning_out','$afternoon_out')";
		}
